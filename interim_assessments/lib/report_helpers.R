...
# --------------- ### Functions for Both Diverse Learner and Gen Ed IA Report Graphics ### ------------



# -------------------- ### Functions for Gen Ed IA Report Graphics ### ---------------------
...
# ------------------- ### Functions for Diverse Learner IA Report Graphics ### -------------
...
## Standards Mastered Grade Level View
...
## Standards Mastered Homeroom View 
...
# Confirming we don't need before deleting 
...
# trying to sort functions by where they are used - CK
